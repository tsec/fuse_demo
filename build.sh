...
arm-openwrt-linux-gcc src/*.c -o build/test -I$STAGING_DIR/include -I$STAGING_DIR/include/glib-2.0  -I./include -L$STAGING_DIR/lib -lglib-2.0 -lfuse -lsqlite3 -lrt -D_FILE_OFFSET_BITS=64 -Wall
